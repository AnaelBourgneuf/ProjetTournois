    ...
    return function(t) {
        ...
        function _(t) {
            ...
            for ("string" == typeof t ? r = t.split(/\s*,\s*/) : "function" == typeof t ? r = [t] : ht.isArray(t) && (r = t), e = 0; e < r.length; e++)
                n = r[e], "string" == typeof n ? i.push("-" === n.charAt(0) ? {
                    field: n.substring(1),
                    order: -1
                } : {
                    field: n,
        ...
        function c(t) {
            var e,
                ...
                i = [];
            for (e = 0; e < t.length; e++)
                n = t[e], "string" == typeof n ? i.push("[" + n + "]") : n.token ? n.token in E ? i.push(w + "[" + n.token + "]") : i.push(n.token) : n.maybe && i.push(b + c(n.maybe) + b);
            return i.join(m)
        }
        function p(t) {
            var e,
        ...
        function f(t, e) {
            ...
            for (n = 0; n < s.length; n++)
                i = s[n], i.charAt(0) === w ? r.push(E[i.substring(1)](e)) : r.push(i);
            return r
        }
        function g(t) {
            ...
            s = function(t) {
                ...
                return i.__extends(e, t), e.prototype.updateDayTable = function() {
                    ...
                    for (e = 0; e < this.rowCnt; e++)
                        n = e * s, i = n + s - 1, r = Math.max(l, n), o = Math.min(u, i), r = Math.ceil(r), o = Math.floor(o), r <= o && d.push({
                            row: e,
                    ...
                    for (e = 0; e < this.rowCnt; e++)
                        for (n = e * a, i = n + a - 1, r = n; r <= i; r++)
                            o = Math.max(u, r), s = Math.min(d, r), o = Math.ceil(o), s = Math.floor(s), o <= s && c.push({
                                row: e,
            ...
            s = function() {
                ...
                return t.prototype.renderComponentFootprint = function(t) {
                    ...
                    var r,
                        ...
                        s = "fc-helper " + (n || "");
                    for (o = this.eventRenderer.renderFgSegEls(o), r = 0; r < o.length; r++)
                        o[r].el.addClass(s);
                    if (null != i)
            ...
            m = function(t) {
                ...
                return i.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
                    ...
                    var t,
                        ...
                        r = this.colCnt,
                        o = "";
                    for (this.headContainerEl && this.headContainerEl.html(this.renderHeadHtml()), t = 0; t < i; t++)
                    ...
                    for (n = 0; n < l.length; n++)
                        if (i = l.eq(n).removeClass("fc-limited"), o = 0, i.find("> td > :first-child").each(e), i.position().top + o > a)
                            return n;
                    return !1
                    ...
                    var n,
                        ...
                        E = function(n) {
                            for (; D < n;)
                                l = m.getCellSegs(t, D, e), l.length && (c = i[e - 1][D], y = m.renderMoreLink(t, D, l), v = r("<div/>").append(y), c.append(v), b.push(v[0])), D++
                        };
                        ...
                        for (n = w.segLevels[e - 1], i = w.cellMatrix, o = w.tbodyEl.children().slice(e).addClass("fc-limited").get(), s = 0; s < n.length; s++) {
                            ...
                            if (u) {
                                for (c = i[e - 1][a.leftCol], p = c.attr("rowspan") || 1, h = [], f = 0; f < d.length; f++)
                                    g = r('<td class="fc-more-cell"/>').attr("rowspan", p), l = d[f], y = this.renderMoreLink(t, a.leftCol + f, [a].concat(l)), v = r("<div/>").append(y), g.append(v), h.push(g[0]), b.push(g[0]);
                    ...
                    for (n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, i = 0; i < n.length; i++)
                    ...
                    var n,
                        ...
                        p = [];
                    for (n = 0; n < t.length; n++)
                        i = t[n], (o = i.footprint.componentFootprint.unzonedRange.intersect(c)) && p.push(r.extend({}, i, {
            ...
            c = function(t) {
                ...
                return r.__extends(e, t), e.prototype.instantiateDayGrid = function() {
                    ...
                    if (!this.dayGrid.rowEls)
                        return void (n || (r = this.computeScrollerHeight(e), this.scroller.setHeight(r)));
        ...
        function r(t, e) {
            var n,
                ...
                s = e.toLegacy();
            for (n = 0; n < t.length; n++) {
                if (i = t[n].eventInstance, r = i.def, !1 === (o = r.getOverlap()))
                    return !1;
        ...
        var i = n(3),
            ...
            u = function() {
                ...
                return t.prototype.buildEventInstanceGroup = function(t, e) {
                    ...
                    if (i.length)
                        return n = new o.default(r.eventDefsToEventInstances(i, e)), n.explicitEventDef = i[0], n
            ...
            H = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    var n,
                        i,
                        o = this.opt(t);
                    if (r.isPlainObject(e) ? (n = e.context, i = e.args) : r.isArray(e) && (i = e), null == n && (n = this.el[0]), i || (i = []), this.triggerWith(t, n, i), o)
                        return o.apply(n, i)
            ...
            m = function(t) {
                ...
                return i.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
                    ...
                    for (e = y.length - 1; e >= 0; e--)
                        if (n = o.duration(y[e]), i = s.divideDurationByDuration(n, t), s.isInt(i) && i > 1)
                            return n;
                    return o.duration(t)
                }, e.prototype.renderDates = function(t) {
            ...
            u = function() {
                ...
                return t.prototype.clearCache = function() {
                    ...
                    for (var e, n, r, l, u, d = this.optionsManager.overrides.views || {}, c = [], p = [], h = [], f = t; f;)
                        e = o.viewHash[f], n = d[f], f = null, "function" == typeof e && (e = {
                            class: e
        ...
        var i = n(3),
            ...
            u = function() {
                ...
                return t.prototype.isWithinRange = function(t, e) {
                    ...
                    for (r.push(t), this.eventDefsByUid[t.uid] = t, e = 0; e < o.length; e++)
        ...
        var l = n(2),
            ...
            c = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    var n,
                        i;
                    for (n = this.timeGrid.groupSegsByCol(t), i = 0; i < this.timeGrid.colCnt; i++)
                    ...
                    if (f.unshift("fc-time-grid-event", "fc-v-event"), o.isMultiDayRange(a.unzonedRange)) {
                        ...
                        n = this.getTimeText(t.footprint), i = this.getTimeText(t.footprint, "LT"), r = this.getTimeText(t.footprint, null, !1);
